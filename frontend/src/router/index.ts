...
const routes: RouteRecordRaw[] = [
  ...
  // Tenant Portal
  {
    ...
    meta: { roles: ['tenant'], label: 'your overview' },
  },
  {
    path: '/tenant/payments',
    name: 'TenantPayments',
    component: TenantPaymentsView,
    meta: { roles: ['tenant'], label: 'your payments' },
  },
  {
    path: '/tenant/tickets',
    name: 'TenantTickets',
    component: TenantTicketsView,
    meta: { roles: ['tenant'], label: 'your repairs' },
  },
  {
    path: '/tenant/profile',
    name: 'TenantProfile',
    component: TenantProfileView,
    meta: { roles: ['tenant'], label: 'your details' },
  },
  ...
  { path: '/admin', redirect: '/admin/overview' },
  {
    ...
    meta: { roles: ['admin'], label: 'the overview' },
  },
  {
    path: '/admin/directory',
    name: 'RoomDirectory',
    component: RoomDirectoryView,
    meta: { roles: ['admin'], label: 'rooms and rates' },
  },
  {
    path: '/admin/tenants',
    name: 'TenantManagement',
    component: TenantManagementView,
    meta: { roles: ['admin'], label: 'the tenant list' },
  },
  {
    path: '/admin/income',
  ...
  },
  {
    ...
    meta: { roles: ['admin'], label: 'repairs' },
  },
  {
