<!--
  ...
  @description Minimalist Corporate Public Property Catalog & Room Inquiry Portal displaying available canonical units.
  @systemBibleRef Section 4 - Public Visitor Role & Section 5.4 - Centralized Inquiries
  @rationale Connects available canonical units dynamically to the landlady inquiry system.
-->
<script setup lang="ts">
import { ref, computed } from 'vue';
import { rooms, isLiveChatheadOpen, selectedInquirerId } from '@/lib/systemState';
import { Send, Building2 } from 'lucide-vue-next';
  ...
  <div class="space-y-6 max-w-5xl mx-auto">
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-for="room in availableRooms" :key="room.id" class="jira-card p-4 flex flex-col justify-between space-y-3">
          <div>
