<!--
  @file views/SystemSettingsView.vue
  @description System configuration and operational business rules summary view.
  @systemBibleRef Section 3 & Section 5 - Business Rules & System Rules
-->
<script setup lang="ts">
import { ShieldCheck, Banknote, FileSpreadsheet, Layers } from 'lucide-vue-next';
</script>
...
<template>
  <div class="space-y-6">
    ...
    <div class="jira-card p-6 space-y-4 text-xs leading-relaxed text-[#172b4d]">
      <div class="p-4 bg-blue-50 border border-blue-200 text-blue-900 rounded-xs space-y-1">
      ...
      <div class="p-4 bg-slate-50 border border-[#dfe1e6] rounded-xs space-y-1">
        <p class="font-bold flex items-center gap-1.5 text-sm"><ShieldCheck class="w-4 h-4 text-[#0c66e4]" /> Primary Payment Method:</p>
      ...
      <div class="p-4 bg-slate-50 border border-[#dfe1e6] rounded-xs space-y-1">
        <p class="font-bold flex items-center gap-1.5 text-sm"><FileSpreadsheet class="w-4 h-4 text-[#0c66e4]" /> Report Exports (BR-049):</p>
