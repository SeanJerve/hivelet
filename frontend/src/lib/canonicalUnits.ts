...
export const CANONICAL_32_UNITS: RentableUnit[] = [
  ...
  { id: 'bh-1e', unitCode: '1e', cluster: 'BH (Main Rooms)', floorLabel: '1st Floor BH', type: 'Studio', basePrice: 4500, status: 'maintenance', tenantName: null, occupants: 0, waterRateType: 'standard' },
