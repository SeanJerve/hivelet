...
<template>
  <footer class="w-full bg-[#0b132b] text-slate-300 pt-16 pb-12 text-xs mt-auto">
    <div class="max-w-[1400px] mx-auto w-full px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-2">
            <span class="font-display font-black text-lg tracking-tight text-white">HIVELET</span>
            <span class="rounded-md bg-white/10 px-2 py-0.5 text-[10px] font-extrabold uppercase text-[#f59e0b]">EST. 2026</span>
          </div>
        ...
        <div class="space-y-3">
          <h4 class="font-display font-bold text-white uppercase tracking-wider text-xs flex items-center gap-1.5">
            <Building2 class="w-3.5 h-3.5 text-[#f59e0b]" />
        ...
        <div class="space-y-3">
          <h4 class="font-display font-bold text-white uppercase tracking-wider text-xs flex items-center gap-1.5">
            <PhoneCall class="w-3.5 h-3.5 text-[#f59e0b]" />
            <span>Contact Us</span>
          </h4>
          <ul class="space-y-3 text-slate-400">
            <li class="flex items-start gap-2.5">
              <Phone class="w-4 h-4 text-[#f59e0b] mt-0.5 shrink-0" />
              <div>
                <span class="block text-[10px] uppercase text-slate-400 font-bold tracking-wider">Contact Number</span>
                <a href="tel:09494150382" class="text-white hover:text-[#f59e0b] font-semibold text-xs transition-colors">
                  09494150382
                </a>
              </div>
            </li>
            <li class="flex items-start gap-2.5">
              <svg class="w-4 h-4 text-[#1877F2] mt-0.5 shrink-0 fill-current" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <div class="min-w-0">
                <span class="block text-[10px] uppercase text-slate-400 font-bold tracking-wider">Facebook</span>
                <a 
                  href="https://www.facebook.com/michelle.millete.16" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  class="text-white hover:text-[#f59e0b] font-semibold text-xs transition-colors flex items-center gap-1 group"
                >
                  <span class="truncate">michelle.millete.16</span>
                  <ExternalLink class="w-3 h-3 text-slate-400 group-hover:text-[#f59e0b] shrink-0" />
                </a>
              </div>
            </li>
          </ul>
        ...
        <div class="space-y-3">
          <h4 class="font-display font-bold text-white uppercase tracking-wider text-xs flex items-center gap-1.5">
            <MapPin class="w-3.5 h-3.5 text-[#f59e0b]" />
      ...
      <div class="pt-8 mt-12 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-400 text-xs border-t border-slate-800">
