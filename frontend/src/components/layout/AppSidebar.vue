 ...
 * @description Left navigation sidebar for the Admin Dashboard, inspired directly by Atlassian/Jira
 *              space navigation. Admin-only -- the Tenant Portal uses its own TenantNavbar shell
 *              (see App.vue), so this component no longer needs to branch on role.
    ...
    >
      <div class="p-3 overflow-y-auto">
        ...
        <div class="px-2.5 py-2 mb-3 bg-[#f4f5f7] border border-[#dfe1e6] rounded-xs">
          ...
          <p class="text-xs font-semibold text-[#172b4d] truncate">Landlady Management Space</p>
        </div>
