/**
 * @file seed.sql
 * @description Canonical Seed Dataset for Hivelet (Fe Galang Da Silva Boarding House).
 ...
 * @rationale Populates realistic, auditable test data across all 32 canonical room units, 5 clusters,
 ...
 * @innovations 
 *  1. Canonical 32-unit room layout pre-populated with exact floor and cluster groupings.
 *  2. Real income report data showcasing ₱200/head water billing and Linda's fixed billing flow.
 *  3. Split expense entries allocating single bills across Boarding House and Main House areas.
 */

-- Clear existing seed data safely (Cascade truncate in development)
...
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'admin@hivelet.ph', 'Fe Galang Da Silva', '09171234567', 'Boarding House Office', '09171234567', 'Property Owner / Landlady', 'admin', 'active'),

-- Active Tenants
('22222222-2222-2222-2222-222222222222', 'b2222222-2222-2222-2222-222222222222', 'mark.cruz@gmail.com', 'Mark Anthony Cruz', '09189876543', 'Elena Cruz (Mother)', '09181112222', 'Software Engineer', 'tenant', 'active'),
('33333333-3333-3333-3333-333333333333', 'c3333333-3333-3333-3333-333333333333', 'sean.jerve@gmail.com', 'Sean Jerve', '09192223333', 'Roberto Jerve (Father)', '09193334444', 'College Student', 'tenant', 'active'),
('44444444-4444-4444-4444-444444444444', 'd4444444-4444-4444-4444-444444444444', 'john.lloyd@gmail.com', 'John Lloyd Santos', '09203334444', 'Clarissa Santos (Sister)', '09204445555', 'Graphic Designer', 'tenant', 'active'),
('55555555-5555-5555-5555-555555555555', 'e5555555-5555-5555-5555-555555555555', 'jaye.casia@gmail.com', 'Jaye Casia (Linda Tenant)', '09214445555', 'Mariano Casia (Father)', '09215556666', 'Accountant', 'tenant', 'active'),

-- Historical / Vacated Tenant
('66666666-6666-6666-6666-666666666666', 'f6666666-6666-6666-6666-666666666666', 'miguel.ramos@gmail.com', 'Miguel Ramos', '09225556666', 'Teresa Ramos (Mother)', '09226667777', 'Former Student', 'tenant', 'inactive'),
