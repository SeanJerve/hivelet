...
Nineteen suites. **12 run on a bare clone**; **16** with `.env`; **all 19** with the backend up
...
| `TESTING_REHEARSAL.md` | 26 steps (28 rows; 23b and 24b are sub-steps), every write path once. No write path has ever been used by a person |
